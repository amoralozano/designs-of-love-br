...
const AboutBanner3 = ({ aboutbanner3: { image, desc } }) => {
  return (
    <div className="w-full h-[600px] md:h-[800px] md:w-[90%] lg:ml-[0px] mt-[200px] lg:mt-[100px] bg-black">
      {" "}
      <img
      ...
      <div className=" relative w-[390px] h-[340px] mr-[10px] md:w-[750px] md:h-[250px] ml-[20px] md:ml-[300px] mt-[-50px] md:mt-[50px] rounded-lg bg-pink-500 border-2 border-pink-500 shadow-lg shadow-pink-500">
        ...
        <Link href="/collection">
          <button
            className="rowdies ml-[90px] md:ml-[210px] bg-black text-pink-500 border-[2px] border-black font-normal px-[15px] md:px-[20px] lg:px-[50px] rounded-lg py-[5px] text-[20px] md:text-[23px] mt-[20px] md:mt-[10px]"
            type="button"
          >
