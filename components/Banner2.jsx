...
const Banner2 = ({ banner2 }) => {
  return (
    ...
    <div className="md:flex md:items-center md:justify-center bg-gray-900 w-full h-[900px] md:h-[700px] mt-[200px] md:mt-[200px] mb-[50px] ">
      <div className="w-[70%] md:w-[45%] bg-green-200 md:bg-gray-900 h-[300px]  md:h-[670px] ml-[65px] rounded-lg lg:ml-[0px]">
        <img
      ...
      <div className="lg:flex lg:items-center lg:justify-center bg-gray-900 w-full md:w-[60%] h-[500px] mt-[-30px] md:mt-[0px] md:h-[670px]">
        <div className=" w-[92%] lg:w-[90%] h-[450px] bg-black ml-[18px] lg:mr-[80px] rounded-lg">
